import { Base, globalConfig, px } from "/lib/ui/Base.js"
...
const CONTAINER_MOUNTS = {
    ...
    stats: {
        ...
        mount: (doc, div) => {
            ...
            let charismaRow = doc.querySelector("#root > div > div.MuiPaper-root.MuiPaper-elevation.MuiPaper-elevation1 > div > div > div > table > tbody > tr:nth-child(14)")
